...
var CFSv2_night=require('users/corfobbppciren2023/LST:2.CFSv2_TFA_Night.js');
var MODIS_night=require('users/corfobbppciren2023/LST:4.MODIS_TFA_Night.js');
var firstYear=require('users/corfobbppciren2023/firstYear:0.firstYear.js');

var MODIS_TFA = ee.Image(MODIS_night.TFA_Images),
    CFSV2_TFA = ee.Image(CFSv2_night.TFA_Images);
